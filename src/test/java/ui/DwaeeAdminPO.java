...
public class DwaeeAdminPO 
{
	...
	public void Dwaee() throws InterruptedException
	{
        ...
        WebElement element = driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div[1]/div/div[2]/div/div[1]/div[2]/div/div/div/div/nav/ul/li[9]/div[1]"));
        // now execute query which actually will scroll until that element is not appeared on page.
        je.executeScript("arguments[0].scrollIntoView(true);",element);
        // Extract the text and verify
        System.out.println(element.getText());
		
		driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div[1]/div/div[2]/div/div[1]/div[2]/div/div/div/div/nav/ul/li[9]/div[1]")).click();
		Thread.sleep(3000);
		driver.findElement(By.partialLinkText("attributes")).click();
		Thread.sleep(3000);
		driver.findElement(By.partialLinkText("Options")).click();
		Thread.sleep(3000);
		driver.findElement(By.partialLinkText("Variations")).click();
		Thread.sleep(3000);
