...
public class DwaeeAdminTax 
{
	...
	public void Dwaee() throws InterruptedException
	{
        ...
        WebElement element = driver.findElement(By.xpath("//span[normalize-space()='Tax']"));
        // now execute query which actually will scroll until that element is not appeared on page.
        je.executeScript("arguments[0].scrollIntoView(true);",element);
        // Extract the text and verify
        System.out.println(element.getText());
		
		driver.findElement(By.xpath("//span[normalize-space()='Tax']")).click();
		Thread.sleep(3000);
		driver.findElement(By.partialLinkText("Classes")).click();
		Thread.sleep(3000);
		driver.findElement(By.partialLinkText("Rate")).click();
		Thread.sleep(3000);
