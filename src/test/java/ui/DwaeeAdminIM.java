...
public class DwaeeAdminIM 
{
	...
	public void Dwaee() throws InterruptedException
	{
        ...
        WebElement element = driver.findElement(By.xpath("//span[normalize-space()='Inventory management']"));
        // now execute query which actually will scroll until that element is not appeared on page.
        je.executeScript("arguments[0].scrollIntoView(true);",element);
        // Extract the text and verify
        System.out.println(element.getText());
		
		driver.findElement(By.xpath("//span[normalize-space()='Inventory management']")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.linkText("Products groups")).click();
		Thread.sleep(3000);
